...
echo "docker run --name $linkedContainer -e ALLOW_ROOT_DOCKER_NETWORK=true -d osixia/mariadb"
docker run --name $linkedContainer -e ALLOW_ROOT_DOCKER_NETWORK=true -d osixia/mariadb 
sleep 10
